...
open_ports() {
	...
	. <(wget -qO- https://raw.githubusercontent.com/f5nodes/logo/main/ports_opening.sh) 31244 31245
...
WantedBy=multi-user.target" > /etc/systemd/system/massad.service
		...
		. <(wget -qO- https://raw.githubusercontent.com/f5nodes/logo/main/insert_variable.sh) -n massa_wallet_address -v "$wallet_address"
		. <(wget -qO- https://raw.githubusercontent.com/f5nodes/logo/main/insert_variables.sh)
		cd
		. <(wget -qO- https://raw.githubusercontent.com/f5nodes/logo/main/logo.sh)
		printf_n "
...
"
		...
		. <(wget -qO- https://raw.githubusercontent.com/f5nodes/logo/main/insert_variable.sh) -n massa_wallet_address -v "$wallet_address"
		. <(wget -qO- https://raw.githubusercontent.com/f5nodes/logo/main/insert_variable.sh) -n massa_log -v "sudo journalctl -f -n 100 -u massad" -a
	fi
	printf_n "${C_LGn}Done!${RES}"
	cd
	. <(wget -qO- https://raw.githubusercontent.com/f5nodes/logo/main/logo.sh)
